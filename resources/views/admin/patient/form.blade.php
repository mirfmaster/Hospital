    ...
    <form class="form-horizontal form-label-left" method="POST" action="{{route('patient.update',$data->id)}}">
        ...
        <form class="form-horizontal form-label-left" method="POST" action="{{route('patient.store')}}">
            ...
            <div class="form-group">
                <label>Name</label>
                <input type="text" name="name" class="form-control" placeholder="Name" id="name" value="{{isset($data) ? $data->name:null}}">
            </div>
            <div class="form-group">
                <label>User Name</label>
                <input type="text" name="username" class="form-control" placeholder="User Name" id="username" value="{{isset($data) ? $data->name:null}}" readonly>
                <div>You don't like the username? just clickin/clickout your name again.</div>
            </div>
            <div class="form-group">
                <label>Date of Birth</label>
                <input type="date" name="birth_date" class="form-control" value="{{isset($data) ? $data->birth_date:null}}">
            </div>
            <div class="form-group">
                <label>Address</label>
            ...
            <div class="form-group">
                <label>Phone</label>
                <input type="text" name="phone" class="form-control" placeholder="Phone" maxlength="13" value="{{isset($data) ? $data->phone:null}}" onkeypress="return isNumberKey(event)">
            </div>
            <center>
