    ...
    <div class="container">
        <div class="row fullscreen align-items-center justify-content-center">
            ...
            <div class="col-lg-6 d-flex align-self-end img-right">
                <img class="img-fluid" src="{{asset('styling/user/img/header-img.png')}}" alt="">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container-fluid">
        <div class="row d-flex justify-content-end align-items-center">
            <div class="col-lg-6 col-md-12 about-left no-padding">
                <img class="img-fluid" src="{{asset('styling/user/img/about-img.jpg')}}" alt="">
            </div>
                ...
                <div class="single-con">
                    <div class="content">
                        <a href="#" target="_blank">
                            ...
                            <img class="content-image img-fluid d-block mx-auto" src="{{asset('styling/user/img/c1.jpg')}}" alt="">
            ...
            <div class="col-lg-3 col-md-3 vol-wrap">
                <div class="single-con">
                    <div class="content">
                        <a href="#" target="_blank">
                            <div class="content-overlay"></div>
                            <img class="content-image img-fluid d-block mx-auto" src="{{asset('styling/user/img/c2.jpg')}}" alt="">
                            <div class="content-details fadeIn-bottom">
                                <h4>Andy Florence</h4>
                                <p>
                                    inappropriate behavior
            ...
            <div class="col-lg-3 col-md-3 vol-wrap">
                <div class="single-con">
                    <div class="content">
                        <a href="#" target="_blank">
                            <div class="content-overlay"></div>
                            <img class="content-image img-fluid d-block mx-auto" src="{{asset('styling/user/img/c3.jpg')}}" alt="">
                            <div class="content-details fadeIn-bottom">
                                <h4>Andy Florence</h4>
                                <p>
                                    inappropriate behavior
            ...
            <div class="col-lg-3 col-md-3 vol-wrap">
                <div class="single-con">
                    <div class="content">
                        <a href="#" target="_blank">
                            <div class="content-overlay"></div>
                            <img class="content-image img-fluid d-block mx-auto" src="{{asset('styling/user/img/c4.jpg')}}" alt="">
                            <div class="content-details fadeIn-bottom">
                                <h4>Andy Florence</h4>
                                <p>
                                    inappropriate behavior
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="single-blog col-lg-4 col-md-4">
                ...
                <img class="f-img img-fluid mx-auto" src="{{asset('styling/user/img/b1.jpg')}}" alt="">
                <h4>
                ...
                <div class="bottom d-flex justify-content-between align-items-center flex-wrap">
                    <div>
                        <img class="img-fluid" src="{{asset('styling/user/img/user.png')}}" alt="">
            ...
            <div class="single-blog col-lg-4 col-md-4">
                <img class="f-img img-fluid mx-auto" src="{{asset('styling/user/img/b2.jpg')}}" alt="">
                <h4>
            ...
            <div class="single-blog col-lg-4 col-md-4">
                <img class="f-img img-fluid mx-auto" src="{{asset('styling/user/img/b3.jpg')}}" alt="">
                <h4>
                    <a href="#">Summer ware are coming</a>
                </h4>
                <p>
