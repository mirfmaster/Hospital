...
<html lang="en">
  ...
  <body class="nav-md footer-fixed menu_fixed">
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="x_panel" style="background-color:#dfe4ea !important;font-color:#000000">
                      <div class="x_title">
    ...
    <!-- FastClick -->
    <script src="{{asset('styling/fastclick.js')}}"></script>
    <!-- NProgress -->
    <script src="{{asset('styling/nprogress.js')}}"></script>
    
    <!-- Custom Theme Scripts -->
    <script src="{{asset('styling/js/custom.min.js')}}"></script>
  </body>
</html>